...
export const BlueSkyAnalyticsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getGlobalStatsForAccount: async (network: Network, accountId: string, metric: Metric, timeframe?: Timeframe, from?: string, to?: string, bucket?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @param {string} [limit] Maximum number of interactions to return
         * @param {string} [offset] Offset for pagination
         * @param {GetPostInteractionsSortEnum} [sort] Sort order for interactions
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getPostInteractions: async (network: Network, accountId: string, postId: string, metric: Metric, timeframe: Timeframe, from: string, to?: string, limit?: string, offset?: string, sort?: GetPostInteractionsSortEnum, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'network' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        getPostStats: async (network: Network, accountId: string, postId: string, metric: Metric, timeframe: Timeframe, from: string, bucket?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'network' is not null or undefined
         ...
         * @param {string} [limit] Maximum number of top posts to return
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getTopPostsForAccount: async (network: Network, accountId: string, timeframe?: Timeframe, limit?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'network' is not null or undefined
...
export const BlueSkyAnalyticsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getGlobalStatsForAccount(network: Network, accountId: string, metric: Metric, timeframe?: Timeframe, from?: string, to?: string, bucket?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<DataPoint>>> {
         ...
         * @throws {RequiredError}
         */
        async getPostInteractions(network: Network, accountId: string, postId: string, metric: Metric, timeframe: Timeframe, from: string, to?: string, limit?: string, offset?: string, sort?: GetPostInteractionsSortEnum, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Interaction>>> {
         ...
         * @throws {RequiredError}
         */
        async getPostStats(network: Network, accountId: string, postId: string, metric: Metric, timeframe: Timeframe, from: string, bucket?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<DataPoint>>> {
         ...
         * @throws {RequiredError}
         */
        async getTopPostsForAccount(network: Network, accountId: string, timeframe?: Timeframe, limit?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<PostsInner>>> {
