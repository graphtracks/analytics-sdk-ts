...
let limit: string; //Maximum number of interactions to return (optional) (default to '10')
let offset: string; //Offset for pagination (optional) (default to undefined)
...
| **limit** | [**string**] | Maximum number of interactions to return | (optional) defaults to '10'|
| **offset** | [**string**] | Offset for pagination | (optional) defaults to undefined|
...
let limit: string; //Maximum number of top posts to return (optional) (default to '10')
...
| **limit** | [**string**] | Maximum number of top posts to return | (optional) defaults to '10'|
